...
public class VerifyConfigsMain extends VerifyFilesMain {
    ...
    private static Map<String, String> stringToWrite = Map.of(
            ...
            "\\PastJobs.csv", "Keywords,Date Range,State,Counties,Status,Job Type,Start Time,End Time"
    );

    public static void verifyConfigs() throws IOException {
        String[] configFiles = {"\\Captchas", "\\API Keys.json", "\\Configs.json", "\\logins.json", "\\PastJobs.csv"};
